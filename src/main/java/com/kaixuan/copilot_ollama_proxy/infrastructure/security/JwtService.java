...
public class JwtService {
    ...
    */
    public JwtService(@Value("${jwt.secret:cosp-default-jwt-secret-key-change-me-in-production}") String secret, @Value("${jwt.ttl-hours:24}") long ttlHours) {
    ...
    */
    public String generateToken(String username, String role) {
        ...
        return Jwts.builder().subject(username).claim("role", role).issuedAt(now).expiration(expiry).signWith(signingKey).compact();
    }
