...
public class AnthropicChatService implements UpstreamChatService {
    ...
    public AnthropicChatService(MimoProxyService proxyService, ObjectMapper objectMapper) {
    ...
    public Flux<String> chatCompletionStream(Map<String, Object> openAiRequest, String model) {
        ...
        return proxyService.streamAnthropicMessages(anthropicBody).flatMap(event -> {
