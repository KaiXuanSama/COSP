...
如果需要适配第三方供应商，可以使用 AI Agent 配合 [docs/cosp-add-provider-skill/SKILL.md](docs/cosp-add-provider-skill/SKILL.md)（英文）或 [docs/cosp-add-provider-skill/SKILL_ZH.md](docs/cosp-add-provider-skill/SKILL_ZH.md)（中文）自动接入你想添加的第三方供应商。

## 现有支持第三方模型供应商

| 供应商 | 说明 | 默认模型 |
|--------|------|----------|
| **[DeepSeek](docs/MODEL_SUPPORT.md#deepseek深度求索)** | DeepSeek 官方 API | `deepseek-v4-flash` |
| **[MiMo](docs/MODEL_SUPPORT.md#mimo小米)** | 小米 AI 服务平台 | `mimo-v2.5-pro` |
| **[LongCat](docs/MODEL_SUPPORT.md#longcat美团)** | 美团 LongCat 系列模型 | `LongCat-Flash-Chat` |
| **[Agnes](docs/MODEL_SUPPORT.md#agnes)** | Agnes AI 服务平台 | `agnes-2.0-flash` |
| **[Zhipu](docs/MODEL_SUPPORT.md#zhipu智谱)** | 智谱 AI 开放平台 | `glm-4.5-air` |
| **[SenseNova](docs/MODEL_SUPPORT.md#sensenova商汤)** | 商汤 AI 服务平台 | `sensenova-6.7-flash-lite` |
| **[Uumit](docs/MODEL_SUPPORT.md#uumit)** | Uumit AI 服务平台 | `Doubao-Seed-2.0-Lite` |

## 模型适配度

> 各模型的兼容性测试结果，请查看 [模型适配度列表](docs/MODEL_SUPPORT.md)。缺陷详情见 [模型兼容性问题报告](docs/MODEL_COMPATIBILITY.md)。
>
> 各供应商的特殊适配逻辑（如思考链缓存、Coding 端点限制处理等），请查看 [供应商特殊适配记录](docs/PROVIDER_ADAPTATIONS.md)。
