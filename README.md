...
| 供应商 | 说明 | 默认模型 |
|--------|------|----------|
| **DeepSeek** | DeepSeek 官方 API | `deepseek-v4-flash` |
| **MiMo** | 小米 AI 服务平台 | `mimo-v2.5-pro` |
| **SenseNova** | 商汤 AI 服务平台 | `sensenova-6.7-flash-lite` |
| **LongCat** | 美团 LongCat 系列模型 | `LongCat-Flash-Chat` |
| **Uumit** | Uumit AI 服务平台 | `Doubao-Seed-2.0-Lite` |

## 模型适配度

> 就目前的测试来看，出问题的只是部分带有思考链的模型，而不带思考链的模型一定没有问题。欢迎测试后提iss以完善此表。
...
| `LongCat-Flash-Thinking-2601` | [缺陷 ⚠️](docs/MODEL_COMPATIBILITY.md#longcat--兼容适配) |
| `LongCat-Flash-Lite` | 未验证 ❓ |
| `LongCat-Flash-Chat` | 未验证 ❓ |
| `LongCat-Flash-Omni-2603` | 未验证 ❓ |
...
| `GLM-5.0` | 可用 |
| `glm-4.7` | 未验证 ❓ |
| `agnes-2.0-flash` | [缺陷 ⚠️](docs/MODEL_COMPATIBILITY.md#agnes-agnes-20-flash--工具调用参数流式生成异常) |
| `agnes-1.5-flash` | [缺陷 ⚠️](docs/MODEL_COMPATIBILITY.md#agnes-15-flash--工具调用能力缺失) |
